...
<div style="font-size: 16px; color: rgb(136, 136, 136); margin-bottom: 8px; padding-bottom: 8px; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(0, 0, 0);">"""+data['name']+"""</div>
